...
createSwaggerExpressMiddleware(specYAML, app, function (err, middleware) {
    if (err) {
        ...
        app.get("/timetables", require("./functionForGetTimetables/src/operations/getTimetables"));
        app.put("/events/stations-sync", require("./eventFunctionStationsSync/src/operations/putEventsStationsSync"));
        app.post("/stations/:id", require("./functionForStations/src/operations/fetchTimeByStation"));
        app.get("/stations", require("./functionForStations/src/operations/getStations"));
